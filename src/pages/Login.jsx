  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        localStorage.setItem("userPhone", data.phone || data.user?.phone || "");

        // ✅ Save full "user" object — Profile page reads this
    ...
    <div style={styles.container}>
      <form style={styles.form} onSubmit={handleLogin}>
        ...
        <p style={styles.link}>
          ...
          <span onClick={() => navigate("/signup")} style={styles.linkSpan}>
            Sign Up
          </span>
        </p>
      </form>
